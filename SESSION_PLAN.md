...
1. [ ] **Fix duplicate runtime error logging** — *Impact: High, Urgency: High*
...
2. [ ] **Runtime error pattern detection** — *Impact: High, Urgency: Medium*
...
3. [ ] **`/runtime-errors clear` and `/runtime-errors summary`** subcommands — *Impact: Medium, Urgency: Medium*
...
4. [ ] **Deduplicate runtime error messages before logging** — *Impact: Medium, Urgency: Medium*
...
5. [ ] **Wire runtime error patterns into evolution planning prompt** — *Impact: High, Urgency: Medium*
